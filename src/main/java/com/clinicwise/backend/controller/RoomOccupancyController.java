...
public class RoomOccupancyController {
    ...
    @GetMapping
    public ListResponse<RoomOccupancyResponse> getAllRoomOccupancies(@ModelAttribute BaseFilter filter) {
        return roomOccupancyService.getAllRoomOccupancies(filter);
    }
